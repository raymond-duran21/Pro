...
import 'react-toastify/dist/ReactToastify.css';
  ...
  const DeleteDialogDocking: FC<DeleteFormProps> =({
    ...
    const handleSubmit = async () => {
        try {
          ...
          if (result.flag === false) {
            ...
            toast.success("Docking eliminado exitosamente");
            setTimeout(() => {window.location.reload();},2000);
          }
        } catch (error) {
          console.error("Error Eliminando docking:", error);
        }
      };
    ...
    <AlertDialogContent>
        ...
        el Docking y eliminará sus datos de nuestros servidores.
        </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
...
export default DeleteDialogDocking;