...
const CreateFormFlotas: FC<CreateFormProps> = () => {
  const [flotasData, setFlotasData] = useState<CreateFlota>({
    marca: "",
    modelo: "",
    serial: "",
    numero: "",
  ...
  return (
    <div>
      ...
      <DialogTrigger asChild>
        <Button variant="outline" >Agregar Flota</Button>
      </DialogTrigger>
        <DialogContent className=" sm:max-w-[925px] ">
          <DialogHeader>
            <DialogTitle>Agregar Flota</DialogTitle>
            <DialogDescription>Introduzca los datos de la Flota.</DialogDescription>
          </DialogHeader>
          ...
          <DialogClose asChild>
            ...
            <Button type="submit" className="relative left-[120px]">Agregar Flotas</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
...
export default CreateFormFlotas;