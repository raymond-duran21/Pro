...
const UpdateFormMonitor: FC<UpdateFormProps> = ({
    id,
}) => {
  const [monitorData, setMonitorData] = useState<UpdateMonitor>({
    id:id,
    direccion: "",
    departamento: "",
    observaciones: "",
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await getMonitorById(id);
      ...
      <DialogTrigger >
        ...
        <DialogContent className="sm:max-w-[525px]">
          <DialogHeader>
            ...
            <DialogDescription>Introduzca los datos del Monitor que quiere editar.</DialogDescription>
          </DialogHeader>
...
export default UpdateFormMonitor;